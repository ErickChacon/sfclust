...
```{r, echo = FALSE}
if (save_figures) {
  ggsave(file.path(path_figures, "canweather-voronoi.pdf"), width = 4.8, height = 4.1,
    device = cairo_pdf)
}
```
...
These panels show the empirical standardized temperature per cluster for the 9 clusters
...
the behavior during the decay phase. For example, most clusters (1–5, 8, and 9) exhibit a
smooth, bell-shaped seasonal pattern, while clusters 6 and 7 show a steeper, more linear
increase leading to a sharper peak.
