...
#     niter = 2000, path_save = file.path("inst", "vigdata", "binomial.rds")
#   )
# )
# #      user    system   elapsed
# # 10625.425  1422.197  1620.283
```
...
```{r, echo = FALSE}
result <- readRDS(system.file("vigdata", "binomial.rds", package = "sfclust"))
names(result)
```
