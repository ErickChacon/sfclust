...
- [`fitted()`](https://rdrr.io/r/stats/fitted.values.html)/[`plot()`](https://rdrr.io/r/graphics/plot.default.html)
  no longer require INLA to be installed when applied to an
  already-fitted `sfclust` object (e.g. one loaded from a saved `.rds`);
