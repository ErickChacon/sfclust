...
This is a minor release (1.0.1 -> 1.1.0) adding
raster `stars` support, a new built-in dataset
(`chapa`), `update()` methods for
continuing/refitting MCMC samples, and several
bug fixes. See NEWS.md for full details.
...
* The maintainer's email address has changed
  since the previous CRAN release (from
  erick.chaconmontalvan@kaust.edu.sa to
  erick.chaconmontalvan@wur.nl). This is an
  intentional, legitimate update.
